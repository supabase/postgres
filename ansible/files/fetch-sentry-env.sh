...
# Fetches AMI ID, instance ID, and region from IMDSv2.
...
# TODO: confirm whether ec2:DescribeTags is available on the instance role
...
# ── Fetch Sentry DSN ──────────────────────────────────────────────────────────
# TODO: DSN delivery mechanism is TBD. Needs to align with how other secrets
# reach these instances at runtime (salt/configman, not SSM directly).
# Placeholder: read from a file written by the config management system.
