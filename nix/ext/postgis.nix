  ...
  build =
    ...
    stdenv.mkDerivation rec {
      ...
      preConfigure = ''
        ...
        makeFlags="PERL=${perl}/bin/perl datadir=$out/share/postgresql pkglibdir=$out/lib bindir=$out/bin docdir=$doc/share/doc/${pname} PG_SHAREDIR=$out/share/postgresql"
      '';
