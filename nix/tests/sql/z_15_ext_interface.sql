...
-- PG15-specific extensions
create extension if not exists adminpack;
create extension if not exists plv8; -- plv8 is non-relocatable (schema = 'pg_catalog')
create extension if not exists plcoffee; -- plcoffee is non-relocatable (schema = 'pg_catalog')
create extension if not exists plls; -- plls is non-relocatable (schema = 'pg_catalog')
