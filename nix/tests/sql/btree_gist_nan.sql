...
SET client_min_messages = warning; -- OrioleDB shows a NOTICE/DETAILS, lets avoid the diff from vanilla
SET enable_seqscan = off; -- Force index scans so we exercise the opclass, not a seqscan recheck.
