...
create table public.visits_2025 partition of public.visits for values from ('2025-01-01') to ('2026-01-01');
create table public.visits_2026 partition of public.visits for values from ('2026-01-01') to ('2027-01-01');
insert into public.visits (visited_at)
  select '2025-06-01'::date + (g % 400) from generate_series(1, 100) g;
